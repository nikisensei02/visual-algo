                ...
                <div>
                    <div>
                        <div className="flex">
                            ...
                            <p className={`${highlightSwapIndex ? 'block' : 'hidden'}`}> &nbsp;swaping {i - 1}th and {i}th index</p>
                        </div>
                        {history.slice().reverse().map((stepArray, index) => (
                            <div key={index} className="flex items-center">
                                <h3 className="mb-6">Step {history.length - index}: </h3>
                                <ul className="flex items-center">
                                    {stepArray.map((char, idx) => (
                                        <li key={idx} className={`p-1 m-1 flex-col`}>
                                            ...
                                            <p className={`${highlightIndex === idx || highlightIndex === idx - 1 ? 'text-black' : 'text-gray-400'}`}>
                                                &nbsp;&nbsp;^
                                            </p>
                                        </li>
                                    ))}
